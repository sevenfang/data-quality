...
public enum FunctionType {
    ...
    BETWEEN_INDEXES_REPLACE_BIJECTIVE(BetweenIndexesReplace.class),
    ...
    KEEP_FIRST_AND_GENERATE_BIJECTIVE(KeepFirstChars.class),
    ...
    KEEP_LAST_AND_GENERATE_BIJECTIVE(KeepLastChars.class),
    ...
    REPLACE_FIRST_CHARS_BIJECTIVE(ReplaceFirstChars.class),
    ...
    REPLACE_LAST_CHARS_BIJECTIVE(ReplaceLastChars.class),
    ...
    REPLACE_NUMERIC_BIJECTIVE(ReplaceNumeric.class),
