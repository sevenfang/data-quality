 ...
 */
public class USPhoneNumberValidator extends AbstractPhoneNumberValidator implements ISemanticSubValidator {

    @Override
    public boolean isValid(String phoneNumber) {
        return isValidPhoneNumber(phoneNumber, Locale.US);
    }
}
